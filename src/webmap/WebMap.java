...
public class WebMap extends Application {
    ...
    public void start(final Stage stage) {
        ...
        loadingPopup.setX(600);
        loadingPopup.setY(300);
        ...
        currentStatus.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent e) {
                // Action to be performed when completed
                Drone d = (Drone) comboBox.getValue();
        ...
        launchDrone.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                d.setIcing(i);
                // Calling the implemented algorithm--
                Algorithm algo = new Algorithm();
                try {
                    algo.implement(d.getInitialCordinate().getLatitude(), d.getInitialCordinate().getLongitude(), d.getFinalCordinate().getLatitude(), d.getFinalCordinate().getLongitude(), d);
                } catch (IOException ex) {
                    Logger.getLogger(WebMap.class.getName()).log(Level.SEVERE, null, ex);
                } catch (ParseException ex) {
                    Logger.getLogger(WebMap.class.getName()).log(Level.SEVERE, null, ex);
